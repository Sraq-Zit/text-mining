...
public class Clustering {
	...
	public Clustering(Algorithm m, Collection<Document> data, int k) {
		if(m == Algorithm.KMEANS) Kmeans(data, k);
		if(m == Algorithm.HIERARCHICAL) Hierarchical(data, k);
	}

	public void Kmeans(Collection<Document> data, int k) {
	...
	int i = 0;
	public void Hierarchical(Collection<Document> data, int k) {
		List<Document> docs = new ArrayList<>(data);
